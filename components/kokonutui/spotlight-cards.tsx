...
const DEFAULT_ITEMS: SpotlightItem[] = [
  {
    icon: Cable,
    title: "Logic Gates & Integrated Circuits",
    description: "Build integrated circuits and logical gate systems.",
    color: "#f59e0b",
  },
  {
    icon: Bot,
    title: "AI Integrated",
    description:
      "Bootstraped with ai tools for developing circuits and design documents.",
    color: "#60a5fa",
  },
  {
    icon: CloudUpload,
    title: "Documentation & Schematics",
    description:
      "Generate documentation and schematics with industry-grade standards.",
    color: "#34d399",
  },
  {
    icon: Code,
    ...
    description:
      "Made for developers and students learning how to make integrated circuits.",
    color: "#a78bfa",
  },
  {
    icon: GitPullRequest,
    title: "Open-Sourced",
    description: "Open-sourced, made for transparency under the MIT license.",
    color: "#38bdf8",
  },
  {
    icon: Cpu,
    title: "Quantum Gates",
    description:
      "Experiment with quantum gates with our helpful tutorialsnpx shadcn@latest add @kokonutui/bento-grid.",
    color: "#f472b6",
  },
];
